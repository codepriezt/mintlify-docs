...
<Info>
  ...
  **Cloud Connectors** are settings that let your Cloudsania account securely connect to your organisation's cloud provider account. This allows Cloudsania to perform actions on behalf of your organisation in the cloud.
</Info>
