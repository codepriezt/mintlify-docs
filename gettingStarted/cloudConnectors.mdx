...
<Accordion title="Cloud Service Providers" defaultOpen={true}>
  *   <Icon icon="cloud-arrow-down" color="white" size={30} />
...
<Steps>
  <Step title="Navigate to the Cloud Connector Module" icon="cloud" />

  <Step title="Click on New Connector to begin the setup process" icon="cloud" />

  <Step title="Select Your Preferred Cloud Service Provider" icon="cloud">
