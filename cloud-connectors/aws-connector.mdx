  ...
  <Tab title="Secure Authentication">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Data Security">
        ...
        - No storage of raw AWS credentialss
      </Accordion>
...
<Info>
  The AWS Connector supports two access models to match your security requirements and operational needs.
</Info>
